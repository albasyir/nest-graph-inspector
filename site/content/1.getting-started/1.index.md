...
::callout{icon="i-lucide-sparkles" color="amber" title="Pro Tip"}
You can try the interactive viewer directly at our [View Page](/view).
::

::callout{icon="i-lucide-triangle-alert" color="warning" title="Important"}
...
These are the common problems Nest Graph Inspector helps solve.

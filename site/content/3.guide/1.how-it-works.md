...
The root module is automatically inferred from where you import `NestGraphInspectorModule.forRoot()`, or you can explicitly set it configuration. This acts as the entry point.

...
#description
Ask graph and trace questions in plain language. In the real viewer, answers are grounded in your loaded runtime graph and generated by a model running inside your browser, so a WebGPU-capable browser is all you need.
